...
import { LayoutDashboard, List, Settings, ChefHat, Bell, Search, User, ShieldCheck, Map as MapIcon } from 'lucide-react';
...
const Layout: React.FC<LayoutProps> = ({ children }) => {
  ...
  const navigation = [
    ...
    { name: 'File d\'attente', href: '/queue', icon: List },
    { name: 'Recettes', href: '/recipes', icon: ChefHat },
    { name: 'Mapping Tableaux', href: '/boards', icon: MapIcon },
        ...
        <div className="absolute bottom-0 w-full p-4 border-t border-slate-100">
          <div className="flex items-center gap-3 p-2 rounded-lg hover:bg-slate-50 cursor-pointer">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500">admin@nutrizen.app</p>
            </div>
          </div>
        </div>
      </aside>
